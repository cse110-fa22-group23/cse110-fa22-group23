...
function addEntry(entry, id, rowIndex = 1) {
    ...
    rowCells.editButton.innerHTML = `<button type="button" id="tableBtn" onclick="editButton(this)"><img src="./assets/images/icons/edit-pen-icon.webp" height=15px alt="edit row"></button>`;
    //  rowCells.deleteButton.innerHTML = `<button type="button" id="createBtn" onclick="deleteButton(this)">Delete</button>`;
    rowCells.deleteButton.innerHTML = `<button type="button" id="tableBtn" onclick="deleteForm(this)"><img src="./assets/images/icons/trash-icon.webp" height=15px alt="delete row"></button>`;
}
